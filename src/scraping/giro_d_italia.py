...
def scrap_giro():
    ...
    print(df_total)
    # Guardar como CSV
    df_total.to_csv("giro_d_italia_2015_2024_etapas.csv", index=False)
    print("✅ Archivo CSV generado: giro_d_italia_2015_2024_etapas.csv")
