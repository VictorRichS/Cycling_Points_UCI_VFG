...
def scrap_tour():
    ...
    RACE_BASE = "/race/tour-de-france/"
    HEADERS = {"User-Agent": "Mozilla/5.0"}

    # Script para extraer resultados del Tour de France 2015-2024
    ...
    print(df_total)
    # Guardar como CSV
    df_total.to_csv("tour_france_2015_2024_etapas.csv", index=False)
    print("✅ Archivo CSV generado: tour_france_2015_2024_etapas.csv")
